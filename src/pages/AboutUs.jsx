export default function AboutUs() {
  return (
    <div className="h-screen w-screen text-amber-100 flex justify-center items-center px-4">
      <div className="flex flex-col w-full sm:w-5/6 md:w-4/6 lg:w-2/3 h-2/3 gap-3 justify-start p-4 sm:p-6 bg-stone-900 rounded-xl border-orange-500 border">
        ...
        <p className="italic text-xs sm:text-sm mt-auto text-center opacity-70">
          Thanks for visiting
        </p>
      </div>
    </div>
